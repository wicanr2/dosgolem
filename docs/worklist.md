...
**被什麼抓到**：verify 開口（找不到「還沒有裁決哪一個對」了）。裁決靠的是三條獨立推導，最硬的一條是 DefaultVGAFrameEvery：那個常數是「一次垂直回掃的指令數」，而 mode 13h 的回掃 70 Hz 是顯示硬體的事實、與 PIT 無關——165,000 × 70 ＝ 11.55 M 指令／秒，只有 17,000 那個標定對得上。

**推論等級**：強證據，非 confirmed：原版素材不在版控裡（[HARD]），沒辦法直接跑 rich2 量 IRQ0Every 當第四個確認。
